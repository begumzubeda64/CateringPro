<%@ Page Title="" Language="C#" MasterPageFile="~/admins.master" AutoEventWireup="true" CodeFile="viewbill.aspx.cs" Inherits="viewbill" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <br />
                ...
                <td>
                    <table class="style5">
                        <tr>
                            <td><center>
                                <br />
                                <font size=5.5px>BILL DETAILS<br />
                                </font><br />
                            </center></td>
                        </tr>
                    </table>
   ...
   <font size="3" style="font-family: georgia; color: White;">
                            ...
                            <asp:Button ID="Button1" CssClass=button runat="server" Text="View Bill"  
                    ...
                    <table class="style4">
                        <tr>
                            ...
                            <td><center>
                                <asp:Label ID="lbl_id" runat="server" ></asp:Label></center></td>
                        </tr>
                        <tr>
                            <td><center>
                                <br />
                            ...
                            <td><center>
                                <asp:Label ID="lbl_date" runat="server" ></asp:Label></center></td>
                        </tr>
                        <tr>
                            <td><center>
                                <br />
                            ...
                            <td><center>
                                <asp:Label ID="lbl_ddate" runat="server" ></asp:Label></center></td>
                        </tr>
                        <tr>
                            <td><center>
                                <br />
                            ...
                            <td><center>
                                <asp:Label ID="lbl_event" runat="server" ></asp:Label></center></td>
                        </tr>
                         <tr>
                            <td><center>
                                <br />
                        ...
                        <tr>
                            ...
                            <td><center>
                                 <asp:Label ID="lbl_bid" runat="server"></asp:Label></center></td>
                        </tr>
                        <tr>
                            <td><center>
                                <br />
                            ...
                            <td><center>
                                <asp:Label ID="lbl_bdate" runat="server"></asp:Label></center></td>
                        </tr>
                        <tr>
                            <td><center>
                            ...
                            <td><center>
                                <asp:Label ID="lbl_tax" runat="server"></asp:Label></center></td>
                        </tr>
                        <tr>
                            <td><center>
                                <br />
                            ...
                            <td><center>
                                <asp:Label ID="lbl_total" runat="server" ></asp:Label></center></td>
                        </tr>
                        <tr>
                            <td><center>
                                <br />
                            ...
                            <td><center>
                                <asp:Label ID="lbl_paid" runat="server"></asp:Label></center></td>
                        </tr>
                        <tr>
                            <td><center>
                                <br />
                            ...
                            <td><center>
                                <asp:Label ID="lbl_unpaid" runat="server"></asp:Label></center></td>
                        </tr>
