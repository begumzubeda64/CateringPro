<%@ Page Title="" Language="C#" MasterPageFile="~/admins.master" AutoEventWireup="true" CodeFile="viewcorder.aspx.cs" Inherits="viewcorder" %>
                ...
                <td>
                    <table class="style2">
                        <tr>
                            <td><center>
                                <br />
                               <font size=5.5px> CANCELLED ORDER DETAILS</font><br /><br />
                                </center></td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <td><center>
                                ...
                                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                                    ...
                                    DataKeyNames="cancel_id" DataSourceID="SqlDataSource2" ForeColor="Black" 
                                    GridLines="Vertical">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                                        ...
                                        <SelectParameters>
                                            <asp:QueryStringParameter DefaultValue="Cancelled" Name="status" 
