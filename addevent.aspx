<%@ Page Title="" Language="C#" MasterPageFile="~/admins.master" AutoEventWireup="true" CodeFile="addevent.aspx.cs" Inherits="addevent" %>
   ...
   <font size="3" style="font-family: georgia; color: White;"><b>
            ...
            <tr>
                <td>
                    ...
                    <table class="style3">
                        ...
                        <tr>
                            <td><center>
                                EVENT NAME</center></td>
                            <td><center>
                                <asp:TextBox ID="tb_event" runat="server" BorderColor="Black" BorderStyle="Inset" 
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                    ControlToValidate="tb_event" Display="Dynamic" 
                                    ErrorMessage="Please enter the event name" Font-Size="12pt" 
       ...
       <font size="3" style="font-family: georgia; color: White;">
                                <asp:Button ID="Button1" runat="server" BorderColor="#FFFFCC" 
                                    ...
                                    style="border-radius: 5px;" Text="ADD EVENT" Width="222px" onclick="Button1_Click" 
                                     />
