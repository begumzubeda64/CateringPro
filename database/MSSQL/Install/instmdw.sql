...
DECLARE @sql_db_single_mode nvarchar(256)
SET @sql_db_single_mode = 'ALTER DATABASE ' + @dbname +
                                    ' SET SINGLE_USER WITH ROLLBACK IMMEDIATE'
EXEC sp_executesql @sql_db_single_mode
GO
...
SET @new_value = '10.0.1600.22'     -- This will be replaced at build time with the sql build number
...
BEGIN
    ...
    IF (@old_value_char <> '10.0.1600.22')   -- value only used during development
    BEGIN
...
INSERT INTO [core].[wait_types] ([category_id],[wait_type]) VALUES (15, N'FSAGENT');
