<%@ Page Title="" Language="C#" MasterPageFile="~/admins.master" AutoEventWireup="true" CodeFile="asignupp.aspx.cs" Inherits="asignupp" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <tr>
                            <td><center>
                               <font size="2px" style="font-family: georgia; color: Red;">*</font> BRANCH<br />
                                <br />
                                <br /></center>
                            </td>
                            <td><center>
                                ...
                                <ContentTemplate>
                                 <asp:DropDownList ID="tb_branch" runat="server" style="border-radius: 5px;" Font-Bold="True" 
        Font-Names="Georgia" Font-Size="15pt" ForeColor="Black" Height="34px" Width="320px" BorderWidth="2px" 
                                     BorderColor="Black" AutoPostBack="True" 
                                     onselectedindexchanged="tb_branch_SelectedIndexChanged">
         <asp:ListItem>Select branch</asp:ListItem>
                                    ...
                                    <asp:Button ID="Button2" runat="server" BorderColor="#FFFFCC" 
                                        ...
                                        style="border-radius: 5px;" Text="ADD NEW BRANCH" Width="197px" 
                                        CausesValidation="False" PostBackUrl="~/branch.aspx" />
                                    </font></b>
             <asp:Label ID="valid_branch" runat="server" Font-Size="12" Font-Bold="True" Font-Names="Georgia"></asp:Label>
                                 <br />
                                </ContentTemplate>
                                </asp:UpdatePanel>
